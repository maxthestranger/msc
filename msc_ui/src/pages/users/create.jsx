...
const INITIAL_STATE = {
    email: '',
    role: '',
    password : random(10000000, 99999999).toString(),
    first_name: '',
    last_name: '',
};
...
export default function Create() {
    ...
    const {
        ...
        errors,
        isSubmitting,
    } = useFormValidation(INITIAL_STATE, validateRegistration, submitForm);
    ...
    async function submitForm() {
        ...
        try {
            ...
            const errorMsg = error.message || 'Error during registration.';
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="flex flex-row items-center justify-between mb-4">
                        ...
                        <h2 className="text-2xl font-semibold text-black">Provide User Details</h2>
                    </div>
